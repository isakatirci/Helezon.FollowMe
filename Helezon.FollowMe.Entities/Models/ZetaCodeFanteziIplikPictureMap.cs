...
namespace Helezon.FollowMe.Entities.Models
{
    ...
    public partial class ZetaCodeFanteziIplikPictureMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ZetaCodeFanteziIplikPicture>
    {
        public ZetaCodeFanteziIplikPictureMap()
            : this("dbo")
        {
        }

        public ZetaCodeFanteziIplikPictureMap(string schema)
        {
            ToTable("ZetaCodeFanteziIplikPicture", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.ZetaCodeFanteziIplikId).HasColumnName(@"ZetaCodeFanteziIplikId").HasColumnType("int").IsRequired();
