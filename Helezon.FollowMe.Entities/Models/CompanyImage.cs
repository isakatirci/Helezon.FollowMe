...
namespace Helezon.FollowMe.Entities.Models
{
    ...
    public partial class CompanyImage: Entity
    {
        ...
        /// <summary>
        /// Parent Company pointed by [CompanyImage].([CompanyId]) (FK_CompanyImage_Company)
        /// </summary>
        public virtual Company Company { get; set; } // FK_CompanyImage_Company
