...
namespace Helezon.FollowMe.Entities.Models.Mapping
{
    ...
    public partial class TermRelationshipMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TermRelationship>
    {
        ...
        public TermRelationshipMap(string schema)
        {
            ToTable("TermRelationship", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.EntityId).HasColumnName(@"EntityId").HasColumnType("nvarchar").IsRequired().HasMaxLength(128);
