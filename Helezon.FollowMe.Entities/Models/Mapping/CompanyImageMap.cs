...
namespace Helezon.FollowMe.Entities.Models.Mapping
{
    ...
    public partial class CompanyImageMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CompanyImage>
    {
        public CompanyImageMap()
            : this("dbo")
        {
        }

        public CompanyImageMap(string schema)
        {
            ToTable("CompanyImage", schema);
            HasKey(x => x.Id);
            ...
            // Foreign keys
            HasOptional(a => a.Company).WithMany(b => b.CompanyImages).HasForeignKey(c => c.CompanyId).WillCascadeOnDelete(false); // FK_CompanyImage_Company
            InitializePartial();
        }
