...
namespace Helezon.FollowMe.Entities.Models
{
    ...
    public partial class ZetaCodeAksesuarPictureMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ZetaCodeAksesuarPicture>
    {
        public ZetaCodeAksesuarPictureMap()
            : this("dbo")
        {
        }

        public ZetaCodeAksesuarPictureMap(string schema)
        {
            ToTable("ZetaCodeAksesuarPicture", schema);
            HasKey(x => x.Id);
