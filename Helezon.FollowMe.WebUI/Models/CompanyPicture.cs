...
namespace FollowMe.Web.Models
{
    ...
    // CompanyPicture
    [Table("CompanyPicture", Schema = "dbo")]
    ...
    public partial class CompanyPicture
    {
        ...
        [Column(@"Extension", Order = 4, TypeName = "nvarchar")]
        [Required(AllowEmptyStrings = true)]
        [MaxLength(50)]
        [StringLength(50)]
        ...
        [Column(@"IsFeatured", Order = 5, TypeName = "bit")]
        [Required]
        ...
        /// </summary>
        [ForeignKey("CompanyId")] public virtual Company Company { get; set; } // FK_CompanyImage_Company
