...
namespace Helezon.FollowMe.WebUI.Controllers
{
    public class ZetaCodeController : Controller
    {
        ...
        string[] KumasOrmeDokumaColumns = {
          ...
          ,"MakineMarkaId"
          ,"MakineModelId"
          ,"YikamaTalimatiKuruTemizleme"
          ,"YikamaTalimatiYikamaSekli"
          ,"YikamaTalimatiYikamaMaxDerecesi"
          ,"YikamaTalimatiUtulemeMaxDerecesi"
          ,"YikamaTalimatiTersYikama"
          ,"YikamaTalimatiCekemezlik"
          ,"YikamaTalimatiDonmezlik"
          ,"YikamaTalimatiYikamaAdedi"
          ,"IsPassive"
          ,"CreatedOn"
          ,"CreatedBy"
          ,"ChangedOn"
